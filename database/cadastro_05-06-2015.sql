...
--
-- Host: 127.0.0.1
-- Generation Time: 05-Jun-2015 às 09:18
...
--
-- Extraindo dados da tabela `tb_files`
--

INSERT INTO `tb_files` (`id`, `solicitation_id`, `attachment`) VALUES
(2, 000011, '000011_PROCURACAO_MANDATO_20150605085102.pdf'),
(3, 000011, '000011_DECLARACAO_PROPOSITO_20150605085124.pdf'),
(4, 000011, '000011_CARTAO_ASSINATURA_20150605085135.pdf'),
(5, 000011, '000011_CARTAO_ASSINATURA_20150605085211.pdf'),
(7, 000011, '000011_ATA_ASSEMBLEIA_20150605091042.pdf');
...
--
-- Extraindo dados da tabela `tb_solicitation`
--

INSERT INTO `tb_solicitation` (`id`, `created`, `updated`, `user_id`, `status_id`, `typeperson_id`, `typesolicitation_id`, `location_id`, `analyst_id`, `notes`, `note_analyst`, `cpf_cnpj`, `scholarity`, `occupation`, `job_firm`, `job_role`, `job_phone`, `job_admission_date`, `spouse_cpf`, `reference`) VALUES
(000011, '2015-06-05', '2015-06-05', 115, 3, 99, 1, 2, 121, 'Apenas um teste...', 'Falta arquivo..', '068.180.406-83', '', '', '', '', '', '', '', 'Fulano da Silva - 33 21012500\r\nCiclano da Silva - 33 99009900');
...
(121, 3, 1, 'caio.cunha@sicoobcrediriodoce.com.br', NULL, 'caioh3027_00', '$2y$13$u8/wnXL.Mc3JUMiAZ5xs8.v.k9zo8nuu8lH6JL4iFl26crjoq.RFu', NULL, NULL, '127.0.0.1', '2015-06-05 12:15:22', NULL, '2015-05-03 01:28:57', '2015-05-03 01:28:57', NULL, NULL),
